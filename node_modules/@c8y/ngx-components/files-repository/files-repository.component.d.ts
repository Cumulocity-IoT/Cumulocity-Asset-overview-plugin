...
import { Pagination, DisplayOptions, Column, Row, LoadMoreMode, ServerSideDataResult, DataSourceModifier, ActionControl, BulkActionControl, ModalService, AlertService, FilesService, ServerSideDataCallback, DataGridComponent } from '@c8y/ngx-components';
...
export declare class FilesRepositoryComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FilesRepositoryComponent, "c8y-files-repository", never, {}, {}, never, never, false>;
}

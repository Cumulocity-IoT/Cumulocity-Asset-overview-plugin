...
export declare class ImageWidgetViewComponent implements OnChanges {
    private imageWidget;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ImageWidgetViewComponent, "c8y-image-widget-view", never, { "config": "config"; }, {}, never, never, false>;
}

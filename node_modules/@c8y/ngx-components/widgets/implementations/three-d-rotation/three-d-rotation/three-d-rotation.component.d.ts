...
export declare class ThreeDRotationComponent implements AfterViewInit, OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ThreeDRotationComponent, "c8y-three-d-rotation", never, { "angles$": "angles$"; "modelObj$": "modelObj$"; "cameraType$": "cameraType$"; "isWireframe$": "isWireframe$"; }, {}, never, never, false>;
}

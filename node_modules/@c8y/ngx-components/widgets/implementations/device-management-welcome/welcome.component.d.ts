...
import { DocLink, NavigatorService } from '@c8y/ngx-components';
import { Router } from '@angular/router';
import * as i0 from "@angular/core";
declare type QuickLink = Pick<DocLink, 'label' | 'click' | 'icon'>;
export declare class WelcomeToDeviceManagementComponent implements OnInit, OnDestroy {
    private router;
    private navigator;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<WelcomeToDeviceManagementComponent, "c8y-welcome-to-devicemanagement", never, {}, {}, never, never, false>;
}
export {};

...
export declare class OpcuaAddressSpaceTreeComponent implements OnInit, OnDestroy, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<OpcuaAddressSpaceTreeComponent, "opcua-address-space-tree", never, { "moId": "moId"; "node": "node"; "focusEmitter": "focusEmitter"; }, { "selectedNode": "selectedNode"; }, never, never, false>;
}

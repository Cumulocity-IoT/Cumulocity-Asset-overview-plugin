...
export declare class OpcuaDeviceProtocolBrowsePathValidation implements Validator {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<OpcuaDeviceProtocolBrowsePathValidation, "[c8yBrowsePathValidator][ngModel]", never, { "getMappings": "getMappings"; "model": "model"; }, {}, never, never, false>;
}

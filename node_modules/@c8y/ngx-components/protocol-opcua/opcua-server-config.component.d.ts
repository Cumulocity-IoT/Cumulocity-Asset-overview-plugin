...
export declare class OpcuaServerConfigComponent implements OnInit, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<OpcuaServerConfigComponent, "opcua-server-config", never, { "server": "server"; }, { "canceled": "canceled"; "removed": "removed"; "saved": "saved"; }, never, never, false>;
}

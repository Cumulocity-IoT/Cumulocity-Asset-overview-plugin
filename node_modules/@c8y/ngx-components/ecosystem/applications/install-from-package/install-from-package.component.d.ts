...
import { ApplicationService, IApplication, IApplicationVersion, InventoryService, IResultList } from '@c8y/client';
...
export declare class InstallFromPackageComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<InstallFromPackageComponent, "c8y-install-from-package", never, {}, {}, never, never, false>;
}

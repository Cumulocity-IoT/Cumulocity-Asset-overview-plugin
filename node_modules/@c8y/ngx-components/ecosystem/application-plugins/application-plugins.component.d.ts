...
import { ActionControl, AlertService, ApplicationPlugin, BulkActionControl, Column, DataGridComponent, DisplayOptions, GainsightService, HeaderActionControl, ModalService, Pagination, PluginsService } from '@c8y/ngx-components';
...
export declare class ApplicationPluginsComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ApplicationPluginsComponent, "c8y-app-plugins", never, { "appId": "appId"; }, {}, never, never, false>;
}

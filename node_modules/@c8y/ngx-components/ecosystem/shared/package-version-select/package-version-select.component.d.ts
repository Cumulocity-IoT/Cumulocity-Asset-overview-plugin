...
export declare class PackageVersionSelectComponent implements OnChanges, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PackageVersionSelectComponent, "c8y-package-version-select", never, { "label": "label"; "packageContextPath": "packageContextPath"; "packageId": "packageId"; }, {}, never, never, false>;
}

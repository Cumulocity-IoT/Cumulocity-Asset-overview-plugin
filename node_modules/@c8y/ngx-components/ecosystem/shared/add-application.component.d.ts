...
export declare class AddApplicationComponent {
    ...
    constructor(ecosystemService: EcosystemService, alertService: AlertService, applicationService: ApplicationService, wizardComponent: WizardComponent, translateService: TranslateService);
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AddApplicationComponent, "c8y-add-application", never, { "headerText": "headerText"; "headerIcon": "headerIcon"; "successText": "successText"; "createApplicationHandler": "createApplicationHandler"; "uploadApplicationHandler": "uploadApplicationHandler"; "canGoBack": "canGoBack"; }, {}, never, never, false>;
}

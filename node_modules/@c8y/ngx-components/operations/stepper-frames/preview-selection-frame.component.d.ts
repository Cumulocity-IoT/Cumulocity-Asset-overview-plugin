...
export declare class PreviewSelectionFrameComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PreviewSelectionFrameComponent, "c8y-preview-selection-frame", never, { "header": "header"; "name": "name"; "description": "description"; "_type": "type"; }, {}, ["previewBlocks"], ["[list]"], false>;
}

...
import { Column, UserPreferencesGridConfigContext } from '@c8y/ngx-components';
...
export declare class DeviceSelectorComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DeviceSelectorComponent, "c8y-device-selector", never, { "deviceTypes": "deviceTypes"; }, { "onDeviceQueryStringChange": "onDeviceQueryStringChange"; }, never, never, false>;
}

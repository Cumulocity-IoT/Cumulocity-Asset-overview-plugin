...
export declare class StatusFilterComponent implements ProductExperienceEventSource {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StatusFilterComponent, "c8y-status-filter", never, { "options": "options"; "_multiple": "multiple"; "_small": "small"; }, { "onFilterChanged": "onFilterChanged"; }, never, never, false>;
}

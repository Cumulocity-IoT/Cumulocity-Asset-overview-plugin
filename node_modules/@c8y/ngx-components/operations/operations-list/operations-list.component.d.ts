...
export declare class OperationsListComponent implements ProductExperienceEventSource {
    ...
    filter(statusFilters: StatusOption[]): Promise<IResultList<IOperation>>;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<OperationsListComponent, "c8y-operations-list", never, {}, {}, never, never, false>;
}

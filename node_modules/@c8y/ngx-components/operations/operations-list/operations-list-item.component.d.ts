...
export declare class OperationsListItemComponent implements OnInit, ProductExperienceEventSource {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<OperationsListItemComponent, "c8y-operations-list-item", never, { "operation": "operation"; "collapsed": "collapsed"; "readOnly": "readOnly"; "noExpandToggle": "noExpandToggle"; }, {}, never, never, false>;
}

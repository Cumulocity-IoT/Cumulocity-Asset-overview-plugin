...
export declare class SingleOperationsListComponent implements AfterViewInit, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SingleOperationsListComponent, "c8y-single-operations-list", never, { "bulkOperation": "bulkOperation"; "readOnly": "readOnly"; }, { "onRetryFailedOperations": "onRetryFailedOperations"; }, never, never, false>;
}

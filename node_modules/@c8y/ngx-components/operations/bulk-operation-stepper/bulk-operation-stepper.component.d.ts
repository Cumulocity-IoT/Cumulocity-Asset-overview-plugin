...
export declare class BulkOperationStepper implements OnDestroy {
    ...
    stepperButtonsLabels: {
        custom: "Schedule bulk operation";
    };
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BulkOperationStepper, "c8y-bulk-operation-stepper", never, { "type": "type"; }, { "selectionChange": "selectionChange"; }, ["customSteps"], never, false>;
}

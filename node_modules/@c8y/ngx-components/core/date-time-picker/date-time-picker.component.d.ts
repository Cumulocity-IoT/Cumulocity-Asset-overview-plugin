...
export declare class DateTimePickerComponent implements ControlValueAccessor, Validator, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DateTimePickerComponent, "c8y-date-time-picker", never, { "_minDate": "minDate"; "_maxDate": "maxDate"; "placeholder": "placeholder"; }, {}, never, never, false>;
}

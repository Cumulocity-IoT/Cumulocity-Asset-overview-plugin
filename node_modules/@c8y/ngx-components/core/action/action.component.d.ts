 ...
 * ```
 */
export declare class ActionComponent implements ActionWithTemplate {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ActionComponent, "c8y-action", never, { "disabled": "disabled"; "priority": "priority"; "icon": "icon"; "injector": "injector"; }, {}, never, ["*"], false>;
}

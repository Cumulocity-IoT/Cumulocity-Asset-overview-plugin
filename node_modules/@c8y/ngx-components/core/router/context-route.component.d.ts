...
export declare class ContextRouteComponent {
    ...
    constructor(route: ActivatedRoute, contextRouteService: ContextRouteService);
    ngOnInit(): void;
    ngOnDestroy(): void;
    refreshTabs(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<ContextRouteComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<ContextRouteComponent, "c8y-context-route", never, {}, {}, never, never, false>;
}

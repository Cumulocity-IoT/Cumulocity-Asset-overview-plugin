...
export declare class SelectModalComponent implements ProductExperienceEventSource {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SelectModalComponent, "c8y-select-modal", never, { "icon": "icon"; "title": "title"; "subTitle": "subTitle"; "items": "items"; "mode": "mode"; "disableSelected": "disableSelected"; "showFilter": "showFilter"; "additionalFilterTemplate": "additionalFilterTemplate"; "areMoreEntries": "areMoreEntries"; "labels": "labels"; "noItemsMessage": "noItemsMessage"; }, { "result": "result"; "search": "search"; "onChoiceUpdated": "onChoiceUpdated"; }, never, never, false>;
}
export {};

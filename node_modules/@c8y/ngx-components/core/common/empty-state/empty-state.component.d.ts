...
export declare class EmptyStateComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<EmptyStateComponent, "c8y-ui-empty-state", never, { "icon": "icon"; "title": "title"; "subtitle": "subtitle"; "horizontal": "horizontal"; }, {}, never, ["*"], false>;
}

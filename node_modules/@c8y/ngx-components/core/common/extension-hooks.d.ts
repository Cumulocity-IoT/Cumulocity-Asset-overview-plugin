...
export declare type GenericHookType<T> = T | T[] | Type<ExtensionFactory<T>>;
/**
 ...
 */
export declare function hookGeneric<T>(items: GenericHookType<T>, token: InjectionToken<T>, options?: Partial<HookOptions>): ValueProvider | ClassProvider | ExistingProvider;

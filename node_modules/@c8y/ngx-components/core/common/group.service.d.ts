...
declare type MoTypes = typeof MO_TYPES[number];
declare type Icon = Partial<{
    icon: string;
    iconOpen?: string;
    iconClass?: string;
}>;
declare type Icons = Partial<Record<MoTypes, Icon>>;
export declare class GroupService {
     ...
     */
    getIcon(mo: IManagedObject, open?: boolean): Promise<string>;
    /**

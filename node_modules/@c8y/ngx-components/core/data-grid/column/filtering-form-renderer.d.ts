...
export declare class FilteringFormRendererContext {
    property: Column;
...
export declare class FilteringFormRendererDefDirective {
    template: TemplateRef<any>;
    constructor(template: TemplateRef<any>);
    static ɵfac: i0.ɵɵFactoryDeclaration<FilteringFormRendererDefDirective, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<FilteringFormRendererDefDirective, "[c8yFilteringFormRendererDef]", never, {}, {}, never, never, false>;
}

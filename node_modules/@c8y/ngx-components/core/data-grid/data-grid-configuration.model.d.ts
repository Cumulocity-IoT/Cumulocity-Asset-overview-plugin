 ...
 */
export declare type GridConfigPart = 'filter' | 'sort' | 'customColumns' | 'order' | 'visibility';
/**
 ...
 */
export declare type GridConfigFilter = {
 ...
 */
export declare type GridEventType = 'filter' | 'sort' | 'pagination' | 'addCustomColumn' | 'removeCustomColumn' | 'reorderColumn' | 'changeColumnVisibility';
/**

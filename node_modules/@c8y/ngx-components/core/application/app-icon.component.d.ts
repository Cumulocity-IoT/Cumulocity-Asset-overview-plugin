...
export declare class AppIconComponent implements OnInit {
    private options;
    contextPath: string;
    name: string;
    app: any;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AppIconComponent, "c8y-app-icon", never, { "contextPath": "contextPath"; "name": "name"; "app": "app"; }, {}, never, never, false>;
}

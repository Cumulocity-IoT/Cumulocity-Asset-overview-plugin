 ...
 * ```
 */
export declare class AlertOutletComponent extends AlertOutletBase {
    private position;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AlertOutletComponent, "c8y-alert-outlet", never, {}, {}, never, never, false>;
}

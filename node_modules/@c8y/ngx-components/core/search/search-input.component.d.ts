...
export declare class SearchInputComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SearchInputComponent, "c8y-search-input", never, { "mode": "mode"; "enableCustomTemplatePlaceholder": "enableCustomTemplatePlaceholder"; "customPlaceholder": "customPlaceholder"; "externalTerm": "externalTerm"; "customDataQuery": "customDataQuery"; "container": "container"; "groupsOnly": "groupsOnly"; }, { "filter": "filter"; "search": "search"; "reset": "reset"; "onClick": "onClick"; }, never, ["*"], false>;
}

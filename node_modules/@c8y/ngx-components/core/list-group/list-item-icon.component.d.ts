 ...
 * ```
 */
export declare class ListItemIconComponent {
    /**
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ListItemIconComponent, "c8y-list-item-icon, c8y-li-icon", never, { "icon": "icon"; "status": "status"; }, {}, never, ["*"], false>;
}

...
export declare class ListItemCheckboxComponent extends CheckboxControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ListItemCheckboxComponent, "c8y-list-item-checkbox, c8y-li-checkbox", never, { "selected": "selected"; "disabled": "disabled"; "displayAsSwitch": "displayAsSwitch"; }, { "onSelect": "onSelect"; }, never, ["*"], false>;
}

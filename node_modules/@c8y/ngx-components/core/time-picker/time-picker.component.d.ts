...
export declare class TimePickerComponent implements ControlValueAccessor, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TimePickerComponent, "c8y-time-picker", never, { "minDate": "minDate"; "maxDate": "maxDate"; "placeholder": "placeholder"; }, { "dayForward": "dayForward"; "dayBackward": "dayBackward"; }, never, never, false>;
}

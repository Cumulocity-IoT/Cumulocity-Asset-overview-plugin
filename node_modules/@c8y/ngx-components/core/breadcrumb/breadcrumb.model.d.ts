 ...
 */
export declare type BreadcrumbItem = BreadcrumbItemWithComponent | BreadcrumbItemWithLabel;
 ...
 */
export declare type BreadcrumbFactory = ExtensionFactory<Breadcrumb>;
export {};

 ...
 * ```
 */
export declare type DynamicComponentExtension = DynamicComponentDefinition | DynamicComponentDefinition[] | ExtensionFactory<DynamicComponentDefinition>;
/**
 ...
 *   ```
 */
export declare type DynamicComponentDefinition = DynamicComponentDefinitionBase & DynamicComponents;
...
export declare type DynamicComponents = EagerDynamicComponents | LazyDynamicComponents;

...
export declare class DynamicComponentComponent implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DynamicComponentComponent, "c8y-dynamic-component", never, { "componentId": "componentId"; "config": "config"; "mode": "mode"; "notFoundError": "notFoundError"; "executeResolvers": "executeResolvers"; }, { "updateWidgetClasses": "updateWidgetClasses"; }, never, never, false>;
}

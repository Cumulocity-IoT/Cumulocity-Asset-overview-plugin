...
export declare class WizardComponent<T = any> implements Wizard<T>, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<WizardComponent<any>, "c8y-wizard", never, { "id": "id"; "wizardConfig": "wizardConfig"; }, { "onClose": "onClose"; "onReset": "onReset"; "onSelect": "onSelect"; }, never, never, false>;
}

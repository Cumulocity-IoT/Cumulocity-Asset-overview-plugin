...
export declare class WizardOutletComponent implements AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<WizardOutletComponent, "c8y-wizard-outlet", never, { "initialState": "initialState"; "id": "id"; }, { "onSelect": "onSelect"; "onPath": "onPath"; }, never, never, false>;
}

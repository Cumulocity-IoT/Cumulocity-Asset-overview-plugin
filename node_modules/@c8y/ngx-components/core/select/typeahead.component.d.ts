...
export declare class TypeaheadComponent implements ControlValueAccessor, Validator, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TypeaheadComponent, "c8y-typeahead", never, { "required": "required"; "maxlength": "maxlength"; "disabled": "disabled"; "allowFreeEntries": "allowFreeEntries"; "placeholder": "placeholder"; "displayProperty": "displayProperty"; "icon": "icon"; "name": "name"; "autoClose": "autoClose"; "hideNew": "hideNew"; "container": "container"; "selected": "selected"; }, { "onSearch": "onSearch"; "onIconClick": "onIconClick"; }, ["list"], ["div, c8y-li, c8y-list-item, button, a"], false>;
}

 ...
 * ```
 */
export declare class RangeComponent implements OnDestroy, ControlValueAccessor {
    /**
     * The range input
     */
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<RangeComponent, "c8y-range", never, {}, {}, ["range", "rangeValue"], ["*"], false>;
}

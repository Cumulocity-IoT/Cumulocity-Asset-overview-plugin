...
export declare class FormGroupComponent implements AfterContentInit, DoCheck, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FormGroupComponent, "c8y-form-group", never, { "hasError": "hasError"; "hasWarning": "hasWarning"; "hasSuccess": "hasSuccess"; "novalidation": "novalidation"; "status": "status"; }, {}, ["customErrorMessage", "model", "formControlName"], ["*"], false>;
}

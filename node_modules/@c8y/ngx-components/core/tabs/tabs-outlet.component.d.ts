import { Renderer2, ElementRef, OnDestroy, AfterContentInit, OnChanges, SimpleChanges } from '@angular/core';
...
export declare class TabsOutletComponent implements OnDestroy, AfterContentInit, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TabsOutletComponent, "c8y-tabs-outlet,c8y-ui-tabs", never, { "tabs": "tabs"; "orientation": "orientation"; "navigatorOpen": "navigatorOpen"; }, {}, never, never, false>;
}

...
export declare class DashboardComponent implements AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DashboardComponent, "c8y-dashboard", never, { "columns": "columns"; "gap": "gap"; "rows": "rows"; }, { "dashboardChange": "dashboardChange"; }, never, ["*"], false>;
}

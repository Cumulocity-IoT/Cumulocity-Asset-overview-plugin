 ...
 */
export declare type ActionBarItem = ActionBarItemWithTemplate | ActionBarItemWithComponent;
 ...
 */
export declare type ActionBarFactory = ExtensionFactory<ActionBarItem>;
export {};

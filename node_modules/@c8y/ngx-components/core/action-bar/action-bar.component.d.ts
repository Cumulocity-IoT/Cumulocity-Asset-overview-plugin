...
export declare class ActionBarComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ActionBarComponent, "c8y-action-bar", never, { "navigatorOpen": "navigatorOpen"; "hasTabs": "hasTabs"; "isTabsHorizontal": "isTabsHorizontal"; "items$": "items$"; }, {}, never, never, false>;
}

...
import { ActionBarItemWithComponent } from './action-bar.model';
 ...
 * ```
 */
export declare class ActionBarItemComponent implements ActionBarItemWithComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ActionBarItemComponent, "c8y-action-bar-item", never, { "placement": "placement"; "priority": "priority"; "itemClass": "itemClass"; "injector": "injector"; "groupId": "groupId"; }, {}, never, ["*"], false>;
}

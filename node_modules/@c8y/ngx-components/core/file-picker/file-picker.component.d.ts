...
export declare class FilePickerComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FilePickerComponent, "c8y-file-picker", never, { "maxAllowedFiles": "maxAllowedFiles"; "uploadChoice": "uploadChoice"; "fileUrl": "fileUrl"; "fileBinary": "fileBinary"; "config": "config"; "fileUrlPopover": "fileUrlPopover"; }, { "onFilesPicked": "onFilesPicked"; }, never, never, false>;
}

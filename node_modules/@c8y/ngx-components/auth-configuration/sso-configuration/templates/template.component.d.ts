...
export declare abstract class TemplateComponent<T> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TemplateComponent<any>, "ng-component", never, { "apps": "apps"; "groups": "groups"; "inventoryRoles": "inventoryRoles"; "ssoConfiguration": "ssoConfiguration"; "ssoConfigurationChangeTrigger": "ssoConfigurationChangeTrigger"; }, { "ssoConfigurationChange": "ssoConfigurationChange"; }, never, never, false>;
}

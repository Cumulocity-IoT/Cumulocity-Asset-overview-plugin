...
import { AlertService, ManagedObjectRealtimeService, OperationRealtimeService, ProductExperienceEvent, ProductExperienceEventSource } from '@c8y/ngx-components';
...
export declare class DeviceTabProfileComponent implements OnInit, OnDestroy, ProductExperienceEventSource {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DeviceTabProfileComponent, "c8y-device-tab-profile", never, {}, {}, never, never, false>;
}

...
import { ActionControl, AlertService, Column, DataGridService, DataSourceModifier, ModalService, ServerSideDataResult } from '@c8y/ngx-components';
...
export declare class SoftwareListComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SoftwareListComponent, "c8y-software-list", never, {}, {}, never, never, false>;
}

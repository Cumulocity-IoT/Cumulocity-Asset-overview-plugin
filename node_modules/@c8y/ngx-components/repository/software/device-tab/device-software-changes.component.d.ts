...
export declare class DeviceSoftwareChangesComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DeviceSoftwareChangesComponent, "c8y-device-software-changes", never, { "changes": "changes"; "changesInProgress": "changesInProgress"; }, { "clear": "clear"; "drop": "drop"; "apply": "apply"; "hideSoftwareChanges": "hideSoftwareChanges"; }, never, never, false>;
}

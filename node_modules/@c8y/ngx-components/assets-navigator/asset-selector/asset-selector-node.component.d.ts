...
export declare class AssetSelectorNodeComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AssetSelectorNodeComponent, "c8y-asset-selector-node", never, { "node": "node"; "rootNode": "rootNode"; "preselected": "preselected"; "showPath": "showPath"; "multi": "multi"; "view": "view"; "index": "index"; "active": "active"; "selectedItems": "selectedItems"; "handleNextMillerViewColumn": "handleNextMillerViewColumn"; }, { "isLoadingState": "isLoadingState"; "onSelect": "onSelect"; "onDeselect": "onDeselect"; }, never, never, false>;
}

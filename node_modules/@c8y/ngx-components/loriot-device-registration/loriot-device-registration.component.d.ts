...
import { LoriotDevice, LoriotDeviceFormly } from './loriot-device-registration.model';
...
export declare class LoriotDeviceRegistrationComponent {
    ...
    getApplications$(name: any): import("rxjs").Observable<import("@c8y/client").IResultList<import("./loriot-device-registration.model").Application>>;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<LoriotDeviceRegistrationComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<LoriotDeviceRegistrationComponent, "c8y-loriot-registration", never, {}, {}, never, never, false>;
}
export {};

...
EcosystemService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: EcosystemService, deps: [{ token: i2.ModalService }, { token: i2.AlertService }, { token: i2.HumanizeAppNamePipe }, { token: i2$1.TranslateService }, { token: i3.ApplicationService }, { token: i2.AppStateService }, { token: i2.ZipService }, { token: i3.TenantService }, { token: i3.InventoryService }, { token: i2.WizardModalService }], target: i0.ɵɵFactoryTarget.Injectable });
...
AddApplicationComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: AddApplicationComponent, deps: [{ token: EcosystemService }, { token: i2.AlertService }, { token: i3.ApplicationService }, { token: i2.WizardComponent }, { token: i2$1.TranslateService }], target: i0.ɵɵFactoryTarget.Component });
...
TranslatePackageLabelPipe.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: TranslatePackageLabelPipe, deps: [{ token: i2$1.TranslateService }], target: i0.ɵɵFactoryTarget.Pipe });
TranslatePackageLabelPipe.ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "14.0.6", ngImport: i0, type: TranslatePackageLabelPipe, name: "translatePackageLabel" });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: TranslatePackageLabelPipe, decorators: [{
            type: Pipe,
...
ApplicationCardComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ApplicationCardComponent, deps: [{ token: i3.ApplicationService }, { token: EcosystemService }, { token: i2.AlertService }, { token: i4.Router }, { token: i2.WizardModalService }, { token: i2.AlertService }, { token: i2.PluginsService }, { token: i2.GainsightService }], target: i0.ɵɵFactoryTarget.Component });
...
DuplicateApplicationComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DuplicateApplicationComponent, deps: [{ token: EcosystemService }, { token: i3.ApplicationService }, { token: i2.WizardComponent }], target: i0.ɵɵFactoryTarget.Component });
...
PackageVersionSelectComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: PackageVersionSelectComponent, deps: [{ token: i3.ApplicationService }, { token: i2.PluginsService }], target: i0.ɵɵFactoryTarget.Component });
PackageVersionSelectComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.0.6", type: PackageVersionSelectComponent, selector: "c8y-package-version-select", inputs: { label: "label", packageContextPath: "packageContextPath", packageId: "packageId" }, providers: [
        {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: PackageVersionSelectComponent, decorators: [{
            type: Component,
...
UploadArchiveComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: UploadArchiveComponent, deps: [{ token: EcosystemService }, { token: i2.AlertService }], target: i0.ɵɵFactoryTarget.Component });
...
SharedEcosystemModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: SharedEcosystemModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
SharedEcosystemModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.0.6", ngImport: i0, type: SharedEcosystemModule, declarations: [AddApplicationComponent,
        ...
        TranslatePackageLabelPipe], imports: [CoreModule, BsDropdownModule, TooltipModule, A11yModule], exports: [AddApplicationComponent,
        ApplicationPropertiesFormComponent,
        UploadArchiveComponent,
        ApplicationCardComponent,
        DuplicateApplicationListComponent,
...
SharedEcosystemModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: SharedEcosystemModule, providers: [
        hookWizard({
    ...
    ], imports: [CoreModule, BsDropdownModule, TooltipModule, A11yModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: SharedEcosystemModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [CoreModule, BsDropdownModule, TooltipModule, A11yModule],
                    declarations: [

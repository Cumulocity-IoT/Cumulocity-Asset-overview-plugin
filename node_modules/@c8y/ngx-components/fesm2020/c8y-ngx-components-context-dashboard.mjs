...
ReportDashboardService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardService, deps: [{ token: i1.InventoryService }, { token: i5.NavigatorService }], target: i0.ɵɵFactoryTarget.Injectable });
ReportDashboardService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardService, decorators: [{
            type: Injectable
...
ReportDashboardNavigationFactory.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardNavigationFactory, deps: [{ token: i5.NavigatorService }, { token: i1.InventoryService }, { token: ReportDashboardService }], target: i0.ɵɵFactoryTarget.Injectable });
ReportDashboardNavigationFactory.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardNavigationFactory, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardNavigationFactory, decorators: [{
            type: Injectable,
...
AddDashboardComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: AddDashboardComponent, deps: [{ token: AddDashboardFactory }], target: i0.ɵɵFactoryTarget.Component });
AddDashboardComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.0.6", type: AddDashboardComponent, selector: "li[c8y-add-dashboard]", host: { classAttribute: "d-flex a-i-stretch" }, ngImport: i0, template: "<button\n  class=\"btn btn-dot p-l-sm-8 p-r-sm-8 p-l-xs-16 p-r-xs-16\"\n  [attr.aria-label]=\"'Add dashboard' | translate\"\n  tooltip=\"{{ 'Add dashboard' | translate }}\"\n  placement=\"right\"\n  container=\"body\"\n  type=\"button\"\n  [delay]=\"500\"\n  (click)=\"addDashboard()\"\n>\n  <i\n    class=\"icon-20 m-l-4 m-r-4\"\n    c8yIcon=\"plus-circle\"\n  ></i>\n</button>\n<div class=\"p-r-sm-32\"></div>\n", dependencies: [{ kind: "directive", type: i5.IconDirective, selector: "[c8yIcon]", inputs: ["c8yIcon"] }, { kind: "directive", type: i3$2.TooltipDirective, selector: "[tooltip], [tooltipHtml]", inputs: ["adaptivePosition", "tooltip", "placement", "triggers", "container", "containerClass", "boundariesElement", "isOpen", "isDisabled", "delay", "tooltipHtml", "tooltipPlacement", "tooltipIsOpen", "tooltipEnable", "tooltipAppendToBody", "tooltipAnimation", "tooltipClass", "tooltipContext", "tooltipPopupDelay", "tooltipFadeDuration", "tooltipTrigger"], outputs: ["tooltipChange", "onShown", "onHidden", "tooltipStateChanged"], exportAs: ["bs-tooltip"] }, { kind: "pipe", type: i5.C8yTranslatePipe, name: "translate" }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: AddDashboardComponent, decorators: [{
            type: Component,
...
WidgetService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: WidgetService, deps: [{ token: i5.DynamicComponentService }, { token: i3.TranslateService }, { token: CONTEXT_DASHBOARD_CONFIG, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
WidgetService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: WidgetService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: WidgetService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
PasteDashboardActionComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: PasteDashboardActionComponent, deps: [{ token: i0.ViewContainerRef }, { token: i1$1.Router }, { token: ContextDashboardService }, { token: i1.InventoryService }], target: i0.ɵɵFactoryTarget.Component });
...
DashboardActionBarFactory.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DashboardActionBarFactory, deps: [{ token: ContextDashboardService }], target: i0.ɵɵFactoryTarget.Injectable });
DashboardActionBarFactory.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DashboardActionBarFactory, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DashboardActionBarFactory, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
DeviceDashboardGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceDashboardGuard, deps: [{ token: ContextDashboardService }], target: i0.ɵɵFactoryTarget.Injectable });
DeviceDashboardGuard.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceDashboardGuard });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceDashboardGuard, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: ContextDashboardService }]; } });
...
GroupDashboardGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: GroupDashboardGuard, deps: [{ token: ContextDashboardService }], target: i0.ɵɵFactoryTarget.Injectable });
GroupDashboardGuard.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: GroupDashboardGuard });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: GroupDashboardGuard, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: ContextDashboardService }]; } });
...
CockpitDashboardModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: CockpitDashboardModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
CockpitDashboardModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.0.6", ngImport: i0, type: CockpitDashboardModule, declarations: [CockpitDashboardComponent], imports: [CoreModule, ContextDashboardModule] });
CockpitDashboardModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: CockpitDashboardModule, providers: [hookNavigator({ label: gettext('Home'), icon: 'home', priority: 10000, path: '/' })], imports: [CoreModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: CockpitDashboardModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CoreModule,
...
DeviceInfoDashboardComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceInfoDashboardComponent, deps: [{ token: i1$1.ActivatedRoute }, { token: WidgetService }, { token: i3.TranslateService }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceInfoDashboardComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$1.ActivatedRoute }, { type: WidgetService }, { type: i3.TranslateService }]; } });

class DeviceInfoDashboardModule {
}
DeviceInfoDashboardModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceInfoDashboardModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
DeviceInfoDashboardModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.0.6", ngImport: i0, type: DeviceInfoDashboardModule, declarations: [DeviceInfoDashboardComponent], imports: [CommonModule, CoreModule, ContextDashboardModule] });
DeviceInfoDashboardModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceInfoDashboardModule, providers: [
        hookRoute({
            context: ViewContext.Device,
            path: 'device-info',
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceInfoDashboardModule, decorators: [{
            type: NgModule,
            args: [{
...
DeviceManagementHomeDashboardModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceManagementHomeDashboardModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
DeviceManagementHomeDashboardModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.0.6", ngImport: i0, type: DeviceManagementHomeDashboardModule, declarations: [DeviceManagementHomeDashboardComponent], imports: [CommonModule, CoreModule, ContextDashboardModule] });
DeviceManagementHomeDashboardModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceManagementHomeDashboardModule, providers: [
        hookRoute({
            path: '',
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceManagementHomeDashboardModule, decorators: [{
            type: NgModule,
            args: [{
...
ReportDashboardGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardGuard, deps: [{ token: ContextDashboardService }], target: i0.ɵɵFactoryTarget.Injectable });
ReportDashboardGuard.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardGuard });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardGuard, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: ContextDashboardService }]; } });

class ReportDashboardModule {
}
ReportDashboardModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
ReportDashboardModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardModule, declarations: [ReportDashboardListComponent], imports: [CoreModule,
        ContextDashboardModule, i3$2.TooltipModule, i1$1.RouterModule, PopoverModule] });
ReportDashboardModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardModule, providers: [
        ...
        PopoverModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardModule, decorators: [{
            type: NgModule,
            args: [{

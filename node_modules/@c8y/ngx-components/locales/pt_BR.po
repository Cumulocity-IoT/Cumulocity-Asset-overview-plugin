...
msgstr ""
"Para o comportamento correto da aplicação, deve usar somente valores {{ defaultRedirectUrl }} ou\n"
"              {{ host }}, recomenda-se usar o primeiro."
...
"        <var ng-non-bindable>{{ placeholderName }}</var>\n"
"        . Então você pode usar esse placeholderName em ligações tratadas pelo Angular. Também estão disponíveis\n"
...
msgstr "Configurações diversas para o aplicativo atual."
...
"              dados do sensor e dados de uso de aplicativos anônimos."
...
msgstr "Bem-vindo ao {{ vm.appName | humanizeAppName }}"
...
msgstr "{{ count }} item(ns) selecionado(s)."

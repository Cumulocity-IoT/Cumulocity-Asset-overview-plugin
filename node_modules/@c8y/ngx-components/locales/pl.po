...
msgstr ""
"Aby działanie aplikacji było poprawne, można użyć tylko wartości {{ defaultRedirectUrl }} lub\n"
"              {{ host }}; zaleca się użycie tej pierwszej."
...
"        <var ng-non-bindable>{{ placeholderName }}</var>\n"
"        . Później można używać tego symbolu zastępczego w powiązaniach obsługiwanych przez Angular. Dostępne są także\n"
...
"          wyświetlane są dane ogólne na temat tenanta."
...
msgstr "Strona główna tej aplikacji. Domyślnie jest to niestandardowy pulpit, na którym wyświetlane są dane ogólne na temat tenanta."

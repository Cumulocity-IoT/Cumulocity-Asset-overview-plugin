...
"          wanneer u de app hebt geïnstalleerd."
...
msgstr "Wilt u versie {{version}} instellen als de meest recente? Bij de implementatie van een nieuwe app wordt altijd deze versie gebruikt."
...
msgstr ""
"Voor een correct applicatiegedrag kunt u alleen {{ defaultRedirectUrl }}- of\n"
"              {{ host }}}-waarden gebruiken, geadviseerd wordt de eerste te gebruiken."
...
"        <var ng-non-bindable>{{ placeholderName }}</var>\n"
"        . Dan kunt u deze naam voor de tijdelijke aanduiding gebruiken in bindings die door Angular worden beheerd. Er zijn ook\n"
...
msgstr "{{ count }} geselecteerd(e) item(s)."

...
msgstr "Voulez-vous définir la version {{version}} comme la dernière ? Le déploiement d'une nouvelle appli utilisera toujours cette version."
...
msgstr ""
"Pour un comportement adapté de l'application, vous ne pouvez utiliser que {{ defaultRedirectUrl }} ou\n"
"              {{ host }} valeurs, il est conseillé d'utiliser la première méthode."
...
msgstr ""
"Pour qu'un caractère générique soit reconnu, il doit au moins être utilisé au moins une fois dans des accolades sans\n"
"        aucune autre expression, par exemple,\n"
"        <var ng-non-bindable>{{ placeholderName }}</var>\n"
"        . Vous pouvez alors utiliser ce nom de caractère générique dans des associations gérées par Angular. Des fonctions prédéfinies\n"
...
msgstr "Doit avoir {{ requiredLength }} caractères au maximum"
...
msgstr "Bienvenue dans {{ vm.appName | humanizeAppName }}"

...
msgstr "Klicken Sie auf <strong>Weiter</strong>, sobald die Installation der App abgeschlossen ist."
...
msgstr ""
"Für ein korrektes Anwendungsverhalten können Sie nur {{ defaultRedirectUrl }} oder\n"
"              {{ host }}-Werte verwenden, es wird empfohlen, den ersten Wert zu nutzen."
...
msgstr "Keine Dateien zum Hochladen ausgewählt."
...
msgstr "Willkommen zu {{ vm.appName | humanizeAppName }}"
...
msgstr "{{ count }} ausgewählte(s) Element(e)."

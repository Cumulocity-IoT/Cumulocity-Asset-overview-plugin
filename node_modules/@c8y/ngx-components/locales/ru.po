...
msgstr ""
"Для корректной работы приложения допускается использовать только\n"
"              значения {{ defaultRedirectUrl }} или {{ host }}; рекомендуется использовать первое значение.."
...
msgstr "Длина должна быть не менее {{ requiredLength }} символов"
...
msgstr "Длина должна быть не более {{ requiredLength }} символов"
...
msgstr ""
"Мы не собираем персональные данные. С телефона поступают только данные датчиков\n"
"              и анонимизированные данные об использовании приложения."
...
msgstr "Вас приветствует {{ vm.appName | humanizeAppName }}"

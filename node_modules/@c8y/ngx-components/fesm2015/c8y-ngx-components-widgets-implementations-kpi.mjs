...
KpiWidgetViewComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: KpiWidgetViewComponent, deps: [{ token: i4.MeasurementRealtimeService }, { token: i3.ContextDashboardComponent, optional: true }], target: i0.ɵɵFactoryTarget.Component });

...
ApplicationPropertiesGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ApplicationPropertiesGuard, deps: [{ token: i1.EcosystemService }], target: i0.ɵɵFactoryTarget.Injectable });
ApplicationPropertiesGuard.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ApplicationPropertiesGuard });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ApplicationPropertiesGuard, decorators: [{
            type: Injectable
...
AddWebApplicationComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: AddWebApplicationComponent, deps: [{ token: i1.EcosystemService }], target: i0.ɵɵFactoryTarget.Component });
AddWebApplicationComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.0.6", type: AddWebApplicationComponent, selector: "c8y-add-web-application", ngImport: i0, template: `<c8y-add-application
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: AddWebApplicationComponent, decorators: [{
            type: Component,
            args: [{
...
class InstallFromPackageComponent {
    ...
    deployApp() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const config = yield this.ecosystemService.createConfig(this.selectedPackage, formGroupValue);
            ...
            try {
                ...
                const binary = yield this.ecosystemService.getBinary(this.selectedPackage, {
                ...
                // Update manifest
                yield this.ecosystemService.updateAppManifest(newApp, this.selectedPackage);
    ...
    fallbackToCloneLatest(config) {
        return __awaiter(this, void 0, void 0, function* () {
            let clonedPkg;
            try {
                clonedPkg = (yield this.applicationService.clone(this.selectedPackage)).data;
...
EcosystemTabs.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: EcosystemTabs, deps: [{ token: i1$2.Router }], target: i0.ɵɵFactoryTarget.Injectable });
EcosystemTabs.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: EcosystemTabs });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: EcosystemTabs, decorators: [{
            type: Injectable
...
AddMicroserviceComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.0.6", type: AddMicroserviceComponent, selector: "c8y-add-microservice", ngImport: i0, template: `<c8y-add-application
  ...
  ></c8y-add-application>`, isInline: true, dependencies: [{ kind: "component", type: i1.AddApplicationComponent, selector: "c8y-add-application", inputs: ["headerText", "headerIcon", "successText", "createApplicationHandler", "uploadApplicationHandler", "canGoBack"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: AddMicroserviceComponent, decorators: [{
            type: Component,
            args: [{
...
AddPackageComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.0.6", type: AddPackageComponent, selector: "c8y-add-package", ngImport: i0, template: `<c8y-add-application
  ...
  ></c8y-add-application>`, isInline: true, dependencies: [{ kind: "component", type: i1.AddApplicationComponent, selector: "c8y-add-application", inputs: ["headerText", "headerIcon", "successText", "createApplicationHandler", "uploadApplicationHandler", "canGoBack"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: AddPackageComponent, decorators: [{
            type: Component,
            args: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: AppsToUpdateRemotesSelectComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$1.BsModalRef }, { type: i4.TranslateService }]; }, propDecorators: { apps: [{
                type: Input
            }], updateType: [{
                type: Input
            }], pluginName: [{
    ...
    setUploadedVersionAsLatest() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.modal.confirm(gettext('Upload successful'), this.translateService.instant(gettext('Do you want to set version {{version}} as the latest? Deploying a new app will always use this version.'), { version: uploadedVersion.version }), Status.SUCCESS, {
...
PackageGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: PackageGuard, deps: [{ token: i1.EcosystemService }], target: i0.ɵɵFactoryTarget.Injectable });
PackageGuard.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: PackageGuard });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: PackageGuard, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: i1.EcosystemService }]; } });
...
PackageVersionsGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: PackageVersionsGuard, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
PackageVersionsGuard.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: PackageVersionsGuard });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: PackageVersionsGuard, decorators: [{
            type: Injectable
        }] });

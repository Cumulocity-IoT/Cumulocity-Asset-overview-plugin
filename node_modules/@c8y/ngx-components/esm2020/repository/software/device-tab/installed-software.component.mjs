...
InstalledSoftwareComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: InstalledSoftwareComponent, deps: [{ token: i1.RepositoryService }, { token: i2.BsModalService }], target: i0.ɵɵFactoryTarget.Component });

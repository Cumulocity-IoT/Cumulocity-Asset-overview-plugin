...
ImpactProviderSettingsComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ImpactProviderSettingsComponent, deps: [{ token: i1.ImpactConnectivityService }, { token: i2.FormBuilder }, { token: i3.ModalService }, { token: i3.AlertService }], target: i0.ɵɵFactoryTarget.Component });

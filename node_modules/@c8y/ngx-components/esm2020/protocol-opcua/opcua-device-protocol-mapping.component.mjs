...
OpcuaDeviceProtocolMapping.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: OpcuaDeviceProtocolMapping, deps: [{ token: i1.AddressSpaceService }], target: i0.ɵɵFactoryTarget.Component });

...
OpcuaAddressSpaceTreeComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: OpcuaAddressSpaceTreeComponent, deps: [{ token: i1.AddressSpaceService }, { token: i2.OpcuaService }, { token: i3.AlertService }], target: i0.ɵɵFactoryTarget.Component });

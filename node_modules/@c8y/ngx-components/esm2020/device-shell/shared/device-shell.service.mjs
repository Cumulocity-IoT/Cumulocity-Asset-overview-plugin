...
DeviceShellService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DeviceShellService, deps: [{ token: i1.OptionsService }, { token: i2.OperationService }], target: i0.ɵɵFactoryTarget.Injectable });

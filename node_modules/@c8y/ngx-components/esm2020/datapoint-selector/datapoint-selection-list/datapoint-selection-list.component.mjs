...
DatapointSelectionListComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DatapointSelectionListComponent, deps: [{ token: i1.DatapointSelectorService }, { token: i2.DatapointLibraryService }, { token: i3.FormBuilder }, { token: i4.WidgetConfigComponent, optional: true }], target: i0.ɵɵFactoryTarget.Component });

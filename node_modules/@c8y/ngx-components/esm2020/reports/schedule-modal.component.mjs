...
ScheduleModalComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ScheduleModalComponent, deps: [{ token: i1.ReportsService }, { token: i2.BsModalRef }, { token: i3.CronService }], target: i0.ɵɵFactoryTarget.Component });

...
RefreshActionComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: RefreshActionComponent, deps: [{ token: i0.ViewContainerRef }, { token: i1.Router }, { token: i2.ImpactSubscriptionService }, { token: i3.AlertService }], target: i0.ɵɵFactoryTarget.Component });

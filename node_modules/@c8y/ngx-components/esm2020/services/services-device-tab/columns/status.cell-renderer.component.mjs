...
StatusCellRendererComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: StatusCellRendererComponent, deps: [{ token: i1.CellRendererContext }, { token: i2.StatusOptionsService }], target: i0.ɵɵFactoryTarget.Component });

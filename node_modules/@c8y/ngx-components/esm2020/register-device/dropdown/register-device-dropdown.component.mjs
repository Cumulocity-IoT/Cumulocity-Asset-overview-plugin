...
RegisterDeviceDropdownComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: RegisterDeviceDropdownComponent, deps: [{ token: i1.RegisterDeviceExtensionService }, { token: i2.RegisterDeviceService }], target: i0.ɵɵFactoryTarget.Component });

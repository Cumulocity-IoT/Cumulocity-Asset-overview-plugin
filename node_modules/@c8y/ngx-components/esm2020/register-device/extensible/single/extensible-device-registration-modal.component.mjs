...
ExtensibleDeviceRegistrationModalComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ExtensibleDeviceRegistrationModalComponent, deps: [{ token: i1.BsModalRef }, { token: i2.C8yJSONSchema }, { token: i3.ExtensibleDeviceRegistrationService }], target: i0.ɵɵFactoryTarget.Component });

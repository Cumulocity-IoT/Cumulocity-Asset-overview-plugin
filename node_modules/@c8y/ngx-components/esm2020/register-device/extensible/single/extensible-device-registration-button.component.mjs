...
ExtensibleDeviceRegistrationButtonComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ExtensibleDeviceRegistrationButtonComponent, deps: [{ token: i1.ExtensibleDeviceRegistrationService }, { token: i2.BsModalService }], target: i0.ɵɵFactoryTarget.Component });

...
ReportDashboardNavigationFactory.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ReportDashboardNavigationFactory, deps: [{ token: i1.NavigatorService }, { token: i2.InventoryService }, { token: i3.ReportDashboardService }], target: i0.ɵɵFactoryTarget.Injectable });

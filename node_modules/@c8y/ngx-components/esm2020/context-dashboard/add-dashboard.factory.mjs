...
AddDashboardFactory.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: AddDashboardFactory, deps: [{ token: i1.Permissions }, { token: i2.ContextDashboardService }, { token: i3.BsModalService }, { token: i1.ContextRouteService }], target: i0.ɵɵFactoryTarget.Injectable });

...
AddPackageComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: AddPackageComponent, deps: [{ token: i1.EcosystemService }, { token: i2.AppStateService }, { token: i3.PackageAvailabilityService }], target: i0.ɵɵFactoryTarget.Component });

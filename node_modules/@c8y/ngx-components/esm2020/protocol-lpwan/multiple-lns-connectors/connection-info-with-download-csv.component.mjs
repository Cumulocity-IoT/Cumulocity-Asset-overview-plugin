...
ConnectionInfoWithDownloadCsvComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ConnectionInfoWithDownloadCsvComponent, deps: [{ token: i1.BsModalRef }, { token: i2.MultipleLnsConnectorService }, { token: i3.AlertService }, { token: i4.TranslateService }], target: i0.ɵɵFactoryTarget.Component });

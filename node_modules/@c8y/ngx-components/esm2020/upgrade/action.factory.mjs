...
Ng1ActionFactoryService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: Ng1ActionFactoryService, deps: [{ token: i1.BridgeService }, { token: i2.TabsService }], target: i0.ɵɵFactoryTarget.Injectable });

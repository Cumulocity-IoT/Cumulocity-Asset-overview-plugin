...
TabsFactory.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: TabsFactory, deps: [{ token: i1.Router }, { token: i2.SsoConfigurationService }], target: i0.ɵɵFactoryTarget.Injectable });

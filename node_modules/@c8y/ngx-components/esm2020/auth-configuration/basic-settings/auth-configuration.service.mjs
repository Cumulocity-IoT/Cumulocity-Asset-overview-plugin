...
AuthConfigurationService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: AuthConfigurationService, deps: [{ token: i1.TenantLoginOptionsService }, { token: i1.TenantOptionsService }, { token: i1.SystemOptionsService }, { token: i2.AppStateService }, { token: i2.TenantUiService }, { token: i3.TenantLoginOptionMapper }, { token: i1.TenantService }], target: i0.ɵɵFactoryTarget.Injectable });

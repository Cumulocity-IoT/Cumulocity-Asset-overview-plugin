...
SsoConfigurationService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: SsoConfigurationService, deps: [{ token: i1.TenantLoginOptionsService }], target: i0.ɵɵFactoryTarget.Injectable });

...
SelectDeviceProfileStepComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: SelectDeviceProfileStepComponent, deps: [{ token: i1.DeviceProfileService }, { token: i2.TranslateService }], target: i0.ɵɵFactoryTarget.Component });

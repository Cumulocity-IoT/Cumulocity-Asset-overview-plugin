...
BulkOperationListItemComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: BulkOperationListItemComponent, deps: [{ token: i1.BulkOperationListItemService }, { token: i2.BulkOperationsService }, { token: i3.ModalService }, { token: i3.AlertService }, { token: i4.BsModalService }], target: i0.ɵɵFactoryTarget.Component });

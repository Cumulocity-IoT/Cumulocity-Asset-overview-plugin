...
DefaultSubscriptionsComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DefaultSubscriptionsComponent, deps: [{ token: i1.FormBuilder }, { token: i2.DefaultSubscriptionsService }, { token: i3.AlertService }], target: i0.ɵɵFactoryTarget.Component });

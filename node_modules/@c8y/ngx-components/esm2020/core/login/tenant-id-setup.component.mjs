...
TenantIdSetupComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: TenantIdSetupComponent, deps: [{ token: i1.FetchClient }, { token: i2.AppStateService }, { token: i3.LoginService }, { token: i4.AlertService }, { token: i5.TranslateService }], target: i0.ɵɵFactoryTarget.Component });

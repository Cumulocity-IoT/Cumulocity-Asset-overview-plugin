...
ChangePasswordComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ChangePasswordComponent, deps: [{ token: i1.LoginService }, { token: i2.UserService }, { token: i3.PasswordService }, { token: i4.OptionsService }, { token: i5.AlertService }], target: i0.ɵɵFactoryTarget.Component });

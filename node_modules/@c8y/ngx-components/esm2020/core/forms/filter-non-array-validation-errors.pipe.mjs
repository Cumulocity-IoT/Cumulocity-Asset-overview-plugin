...
FilterNonArrayValidationErrorsPipe.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: FilterNonArrayValidationErrorsPipe, deps: [], target: i0.ɵɵFactoryTarget.Pipe });
FilterNonArrayValidationErrorsPipe.ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "14.0.6", ngImport: i0, type: FilterNonArrayValidationErrorsPipe, name: "filterNonArrayValidationErrors" });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: FilterNonArrayValidationErrorsPipe, decorators: [{
            type: Pipe,
            args: [{

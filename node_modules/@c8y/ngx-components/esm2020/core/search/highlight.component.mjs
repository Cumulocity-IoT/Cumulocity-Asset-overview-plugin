...
HighlightComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: HighlightComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
HighlightComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.0.6", type: HighlightComponent, selector: "c8y-highlight", inputs: { pattern: "pattern", text: "text", elementClass: "elementClass", shouldTrimPattern: "shouldTrimPattern" }, viewQueries: [{ propertyName: "container", first: true, predicate: ["text"], descendants: true, read: ElementRef, static: true }], usesOnChanges: true, ngImport: i0, template: '<span [innerHTML]="highlightedText"></span>', isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: HighlightComponent, decorators: [{
            type: Component,
            args: [{

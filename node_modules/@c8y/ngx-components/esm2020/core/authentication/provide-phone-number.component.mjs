...
ProvidePhoneNumberComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ProvidePhoneNumberComponent, deps: [{ token: i1.LoginService }, { token: i2.AlertService }, { token: i3.UserService }], target: i0.ɵɵFactoryTarget.Component });

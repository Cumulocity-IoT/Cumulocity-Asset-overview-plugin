...
BaseFilteringFormRendererComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: BaseFilteringFormRendererComponent, deps: [{ token: i1.FilteringFormRendererContext }, { token: i2.C8yJSONSchema }], target: i0.ɵɵFactoryTarget.Component });

...
UserPreferencesConfigurationStrategy.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: UserPreferencesConfigurationStrategy, deps: [{ token: i1.UserPreferencesService }, { token: DATA_GRID_CONFIGURATION_CONTEXT, optional: true }, { token: DATA_GRID_CONFIGURATION_CONTEXT_PROVIDER, optional: true }, { token: i2.LegacyGridConfigMapperService }], target: i0.ɵɵFactoryTarget.Injectable });
UserPreferencesConfigurationStrategy.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: UserPreferencesConfigurationStrategy, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: UserPreferencesConfigurationStrategy, decorators: [{
            type: Injectable,

...
VersionListComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: VersionListComponent, deps: [{ token: i1.VersionService }, { token: i2.AppStateService }, { token: i3.ClipboardService }, { token: i4.BsModalService }, { token: i5.HeaderService }], target: i0.ɵɵFactoryTarget.Component });

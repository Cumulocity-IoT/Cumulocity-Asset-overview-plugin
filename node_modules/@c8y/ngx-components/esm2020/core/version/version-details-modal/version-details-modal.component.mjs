...
VersionDetailsModalComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: VersionDetailsModalComponent, deps: [{ token: i1.BsModalRef }, { token: i2.VersionService }, { token: i3.PlatformDetailsService }], target: i0.ɵɵFactoryTarget.Component });

...
ProviderConfigurationComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ProviderConfigurationComponent, deps: [{ token: i1.Permissions }, { token: i2.ActivatedRoute }, { token: i3.ModalService }, { token: i4.AlertService }, { token: i5.ProviderDefinitionsService }, { token: i6.ProviderConfigurationService }, { token: i7.C8yJSONSchema }], target: i0.ɵɵFactoryTarget.Component });

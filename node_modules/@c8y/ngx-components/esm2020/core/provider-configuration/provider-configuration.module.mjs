...
ProviderConfigurationModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ProviderConfigurationModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
ProviderConfigurationModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.0.6", ngImport: i0, type: ProviderConfigurationModule, declarations: [ProviderConfigurationComponent], imports: [CoreModule, CommonModule, DynamicFormsModule], exports: [ProviderConfigurationComponent] });
ProviderConfigurationModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ProviderConfigurationModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ProviderConfigurationModule, decorators: [{
            type: NgModule,
            args: [{

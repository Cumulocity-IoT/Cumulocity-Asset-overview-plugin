...
ProviderConfigurationRouteFactory.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ProviderConfigurationRouteFactory, deps: [{ token: HOOK_DYNAMIC_PROVIDER_CONFIG, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
ProviderConfigurationRouteFactory.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ProviderConfigurationRouteFactory, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: ProviderConfigurationRouteFactory, decorators: [{
            type: Injectable,

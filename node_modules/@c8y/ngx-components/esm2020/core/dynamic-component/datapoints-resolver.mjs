...
DynamicDatapointsResolver.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DynamicDatapointsResolver, deps: [{ token: i1.DynamicManagedObjectResolver }], target: i0.ɵɵFactoryTarget.Injectable });
DynamicDatapointsResolver.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DynamicDatapointsResolver, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: DynamicDatapointsResolver, decorators: [{
            type: Injectable,

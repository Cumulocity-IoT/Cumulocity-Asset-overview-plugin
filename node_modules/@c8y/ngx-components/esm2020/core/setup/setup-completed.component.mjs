...
SetupCompletedComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: SetupCompletedComponent, deps: [{ token: i1.C8yStepper }, { token: i2.CdkStep }, { token: i3.SetupComponent }], target: i0.ɵɵFactoryTarget.Component });

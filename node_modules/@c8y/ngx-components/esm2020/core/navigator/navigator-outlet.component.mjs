...
NavigatorOutletComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.0.6", ngImport: i0, type: NavigatorOutletComponent, deps: [{ token: i1.HeaderService }, { token: i2.NavigatorService }], target: i0.ɵɵFactoryTarget.Component });

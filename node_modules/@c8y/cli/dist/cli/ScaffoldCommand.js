...
class ScaffoldCommand extends Commands_1.Commands {
    ...
    async updatePackageJson() {
        ...
        // set contextPath used in remotes to correct value
        const applicationOptions = newAppManifest.c8y.application;
        const oldContextPath = applicationOptions.contextPath;
        if (applicationOptions.remotes && applicationOptions.remotes[oldContextPath]) {
            const remotesOfThisAppsContextPath = applicationOptions.remotes[oldContextPath];
            delete applicationOptions.remotes[oldContextPath];
            applicationOptions.remotes[this.sanatizedName] = remotesOfThisAppsContextPath;
        }

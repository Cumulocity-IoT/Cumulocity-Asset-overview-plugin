 ...
 * Generated on Thu, 14 Sep 2023 10:14:46 GMT
 */

:root, .c8y-light-theme {
  --c8y-elevation-color: 1, 31, 61; /* The rgb values of #011F3D (the palette-gray-10) */
  ...
  --c8y-palette-purple-40: #8E3CF7; /* Accent */
  ...
  --c8y-palette-teal-30: #058192; /* Primary */
  ...
  --c8y-brand-accent-light: var(--c8y-palette-purple-80);
  ...
  --c8y-brand-complementary: var(--brand-complementary, var(--c8y-brand-20));
  --c8y-brand-dark: var(--brand-dark, var(--c8y-brand-10));
  --c8y-brand-light: var(--brand-light, var(--c8y-brand-50));
  --c8y-brand-primary: var(--brand-primary, var(--c8y-brand-30));
  --c8y-code-color: var(--c8y-brand-accent);

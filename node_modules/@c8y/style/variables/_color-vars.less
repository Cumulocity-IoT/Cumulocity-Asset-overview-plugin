...
@brand-10: var(--c8y-brand-10);
@brand-20: var(--c8y-brand-20);
@brand-30: var(--c8y-brand-30);
@brand-40: var(--c8y-brand-40);
@brand-50: var(--c8y-brand-50);
@brand-60: var(--c8y-brand-60);
@brand-70: var(--c8y-brand-70);
@brand-80: var(--c8y-brand-80);

@brand-accent: var(--c8y-brand-accent);
@brand-accent-dark: var(--c8y-brand-accent-dark);

/* Status, feedback states and alerts */
@status-success: var(--c8y-palette-status-success);
@status-success-light: var(--c8y-palette-status-success-light);
@status-success-dark: var(--c8y-palette-status-success-dark);
@status-info: var(--c8y-palette-status-info);
@status-info-light: var(--c8y-palette-status-info-light);
@status-info-dark: var(--c8y-palette-status-info-dark);
@status-danger: var(--c8y-palette-status-danger);
@status-danger-light: var(--c8y-palette-status-danger-light);
@status-danger-dark: var(--c8y-palette-status-danger-dark);
@status-warning: var(--c8y-palette-status-warning);
@status-warning-light: var(--c8y-palette-status-warning-light);
@status-warning-lightest: var(--c8y-palette-status-warning-high);
@status-warning-dark: var(--c8y-palette-status-warning-dark);
...
@navigator-text-color-selected: var(--navigator-color-active, var(--c8y-navigator-text-color-selected));
...
@navigator-background-active: var(--c8y-navigator-background-active);
...
/* RIGHT DRAWER */
@drawer-bg: var(--c8y-drawer-background-default, @navigator-background-default);
@drawer-background-default: @drawer-bg;
@drawer-color: var(--c8y-drawer-text-color-default, @navigator-text-color-default);
@drawer-separator-color: var(--c8y-drawer-separator-color, @navigator-separator-color);
@drawer-background-active: var(--c8y-drawer-background-active, @navigator-background-active);
@drawer-border-selected: var(--c8y-drawer-border-selected, @navigator-border-selected);
@drawer-legend: @navigator-title-color;
...
/* MAIN HEADER */
@header-background-default: var(--header-bg-color, var(--c8y-header-background-default));
@headerColor: var(--header-color, var(--c8y-main-header-background-default));
...
/* Text */
@text-color: var(--text-color, var(--c8y-component-color-default, var(--c8y-root-component-color-default)));
@text-muted: var(--c8y-component-color-text-muted, var(--c8y-root-component-color-text-muted));
...
@link-color-hover: var(--c8y-component-color-link-hover, var(--c8y-root-component-color-link-hover));
...
@component-color-link: var(--c8y-component-color-link, var(--c8y-root-component-color-link));
@component-color-link-hover: var(--c8y-component-color-link-hover, var(--c8y-root-component-color-link-hover));
...
@component-form-label-color: var(--c8y-component-form-label-color, var(--c8y-root-component-form-label-color));
@component-form-legend-color: var(--c8y-component-form-legend-color, var(--c8y-root-component-form-legend-color));

@component-form-control-border-color: var(--c8y-component-form-control-border-color, var(--c8y-root-component-form-control-border-color));
...
@component-disabled-opacity: var(--c8y-component-disabled-opacity, var(--c8y-root-component-disabled-opacity));

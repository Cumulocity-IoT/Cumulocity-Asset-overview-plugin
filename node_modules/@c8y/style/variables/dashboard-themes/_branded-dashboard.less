...
.c8y-grid-dashboard c8y-dashboard-child .panel-content-branded {
  ...
  --c8y-btn-primary-border-color-active: var(--c8y-palette-high);
  --c8y-btn-primary-border-color-focus: var(--c8y-root-component-brand-primary);
  --c8y-btn-primary-border-color-hover: var(--c8y-root-component-brand-primary);
  --c8y-btn-primary-border-color-default: var(--c8y-root-component-brand-primary);
  --c8y-btn-primary-background-active: var(--c8y-brand-50);
  ...
  --c8y-btn-primary-background-default: var(--c8y-root-component-brand-primary);
  --c8y-btn-primary-color-focus: var(--c8y-root-component-brand-primary);
  --c8y-btn-primary-color-hover: var(--c8y-root-component-brand-primary);
  ...
  // --c8y-root-component-icon-dark-color-light: var(--c8y-palette-low);
  // --c8y-root-component-icon-white-color-light: var(--c8y-pallete-low);
...
body:has(.dashboard-theme-branded:not(.dashboard-preview-slot)){
  .c8y-ui-action-bar{

...
@form-control-disabled-opacity:             var(--c8y-form-control-disabled-opacity);
...
@form-control-font-family:                  var(--c8y-form-control-font-family);

@form-control-validation-error:             var(--c8y-form-validation-color-error);
@form-control-validation-warning:           var(--c8y-form-validation-color-warning);
@form-control-validation-success:           var(--c8y-form-validation-color-success);
@form-control-validation-info:              var(--c8y-form-validation-color-info);

...
.thumb() {
  ...
  box-shadow: inset 0 0 0 1px @form-control-border-color-default, 1px 1px 1px rgba(0, 0, 0, 0.1),
...
.label-bottom {
  ...
  .range-value span:before {
    ...
    height: 0;
    border-top: 0;
    border-bottom: 6px solid @component-background-default;
    border-right: 6px solid transparent;
    border-left: 6px solid transparent;
    content: '';
    transform: translateX(-50%);
  ...
  .range-value span:before {
    margin-bottom: 0;
    border-bottom: 6px solid @popover-border-color;
  }
}

...
.dropdown-menu {
  ...
  --c8y-component-background-default: var(--c8y-dropdown-background-default);
  &--date-range {
    min-width: 240px;
  ...
  > li {
    ...
    button:not(.btn):not(.c8y-asset-selector__btn):not(.btn-help) {
      &:not(.btn-add-block):not(.btn-clean) {
        display: flex;
        align-items: center;
        gap: 4px;
...
.dropdown-header {
  ...
  background-color: @component-background-default;
  color: @component-brand-primary !important;
  white-space: nowrap;
